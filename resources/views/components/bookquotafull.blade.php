...
>
    <div class="row">
        <div class="col-12">
            <span id="bookingtitle">Booking Arrivals</span>
		</div>
	</div>
    <div class="row">
        <div class="col-12">
			...
			<!-- 
				<button type="button" @click="$dispatch('refresh');" name="exportbtn" class="btn sortbtn" id="btnexport" title="EXPORT DATA" data-bs-toggle="modal" data-bs-target="#exportm">EXPORT</button>
			-->
		</div>
	</div>
    <div class="table-responsive w-auto" id="stattablebig" >
        <div class="flex justify-between items-center">
            <table class="table table-borderless text-center" id="tablestat">
                <thead id="thead">
                    <tr>
					...
					<template x-for="(accommodation, index) in accommodations" :key="accommodation.id || index">
                        ...
                        <tr class="hover:bg-gray-200 text-gray-900 text-xs">
                            ...
                            <td>
								...
								<span x-text="tarrived(accommodation.name)"></span> /
