        ...
        <div class="row">
				...
				<div class="row">
					<div class="col-md-12 ftco-animate">
						...
						<div class="single-slider owl-carousel">
							...
							<div class="item">
								<div class="room-img" style=" background-repeat: no-repeat; background-size: 100% 100%; background-position: 0rem center; background-image: url(/images/resort/{{ 'supplier' . $accommodation->first()->id . '/' . $image->name}}); "></div>
							</div>
							@endforeach
							@endif
					...
					<div class="col-md-12 room-single mt-4 mb-5 ftco-animate">
						...
						<p id = "justtext">{{$accommodation->first()->description}}</p>
						
						<div class="d-md-flex mt-5 mb-5">
							<ul class="list">
								<li><span>Type:</span> {{ $accommodation->first()->type}}</li>
							</ul>
							<ul class="list ml-md-5">
								<li><span>Logdging:</span> {{ $accommodation->first()->lodge}}</li>
							</ul>
						</div>
					</div>
			...
			<div class="col-lg-4 sidebar ftco-animate">
				<div class="sidebar-box ftco-animate">
					...
					<p>If you have any questions or need more details about {{ $accommodation->first()->name }}, feel free to contact us:</p>
					<p id = "justtext"><strong>Contact Number<br></strong> {{ $accommodation->first()->contactno }}</p>
					<p id = "justtext"><strong>Address<br></strong> {{ $accommodation->first()->address }}</p>
			...
			<button type="button" x-show="booked" class="form-control" id="booknowbtn">RATE</button>
				...
				<div class="sidebar-box">
						...
						<div class="form-group">
							<span></span>
							<p id = "justtext"><strong>Ready for Cagbalete Island?</strong><br> Secure your booking now and experience Cagbalete paradise with {{ $accommodation->first()->name }}.</p>
							<a href="{{ url('booking') . '?booking=' . $accommodation->first()->id }}">
