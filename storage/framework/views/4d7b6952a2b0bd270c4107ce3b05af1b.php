    ...
    <div class="modal-dialog modal-dialog-centered modal-lg"> 
        <div class="modal-content">
            ...
            <div class="modal-footer d-flex justify-content-between">
                <button type="button" class="btn btn-danger mbtn" @click="document.location.href = '<?php echo e(url('/')); ?>';">CANCEL</button>
                <button type="button" class="btn btn-success mbtn" data-bs-dismiss="modal" aria-label="YES" :disabled="!consentcheck">CONFIRM</button>
            </div>
        </div>
    </div>
</div>
<?php /**PATH /home/u101594241/domains/maubantourism.com/public_html/resources/views/components/consentmodal.blade.php ENDPATH**/ ?>