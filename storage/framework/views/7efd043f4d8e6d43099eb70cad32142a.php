	...
	<div class="modal-dialog modal-lg modal-xl">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<form action = "<?php echo e(route('reschedbooking')); ?>" method = "POST" id = "reschedbook" x-validate.input @submit="$validate.submit" novalidate>
					<?php echo csrf_field(); ?> 
...
</div>																									<?php /**PATH /home/u101594241/domains/maubantourism.com/public_html/resources/views/components/reschedmodal.blade.php ENDPATH**/ ?>