...
<div class = "col-12 dashrow2" >
	<div class="row flex space-x-0 items-center">
		...
		<div class="col">
			...
			id="colorsel"
			x-model="colorselect" 
            class="py-2 pr-2 mr-3 rounded-md form-select"
						...
						<table class = "table table-borderless text-center" id = "tablen2" :style="'background: ' + stslight + ';'">
							<tr>
								<tr>
									...
									<td colspan="2">
										<form action = "<?php echo e(route('bookingstatus')); ?>" method ="POST" id="bookstatus" x-data = "statusform()" @submit.prevent="submitData">
											<?php echo csrf_field(); ?> 
											<button type="submit"
											name="sts"
											id="arrbtn"  
...
<?php /**PATH /home/u101594241/domains/maubantourism.com/public_html/resources/views/components/bookingtablefull.blade.php ENDPATH**/ ?>