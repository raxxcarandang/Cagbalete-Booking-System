	...
	<div class="modal-dialog modal-lg modal-xl">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<form action = "<?php echo e(route('updateuser')); ?>" method = "POST" id = "updatebook" x-data="updateuser()" @submit.prevent="updateData" x-validate.input @submit="$validate.submit" novalidate>
					<?php echo csrf_field(); ?> 
					<div class = "row">
						<div class="col-12">
...
</div><?php /**PATH /home/u101594241/domains/maubantourism.com/public_html/resources/views/components/userupdatemodal.blade.php ENDPATH**/ ?>