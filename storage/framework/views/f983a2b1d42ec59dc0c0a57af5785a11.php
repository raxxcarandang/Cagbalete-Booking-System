        ...
        <div class="modal-content">
            ...
            <div class="modal-body justify-center">
                <form enctype="multipart/form-data" id="uploadimg" x-data="imageform()" @submit.prevent="submitImg">
                    ...
                    <input type="hidden" x-model="uploaddate" value="<?php echo e(date('Y-m-d')); ?>" />
                    <br>
...
<?php /**PATH /home/u101594241/domains/maubantourism.com/public_html/resources/views/components/imguploadmodal.blade.php ENDPATH**/ ?>